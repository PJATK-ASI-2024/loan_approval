...
with DAG(
    '3_download-public_split_save',
    start_date=datetime(2023, 1, 1),
    schedule_interval=None,
    catchup=False,
) as dag:

    download_public_task = PythonOperator(
        task_id='download_public_task',
        python_callable=download_public,
    )
    ...
    download_public_task >> split_task >> save_task
